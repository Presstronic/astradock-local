...
- **Corrupt application data:** preserve the original data, avoid destructive automatic reset, and follow the persistence recovery policy from issue #5.
...
- Issue #5 defines durable-data formats, migrations, corruption recovery, and deletion internals consistent with this lifecycle policy.
